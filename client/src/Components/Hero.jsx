    ...
    <div className="scroll-down-animation">
      <div className=" grid fade-in md:grid-cols-2 grid-1 pt-10 md:pt-25 z-99 scroll-animation">
        <div className="w-full fade-in flex flex-col justify-end items-start pl-5 pt-5 md:pt-0 md:pl-15 lg:pl-30 pr-5 md:pr-15 md:order-1 order-2  ">
          <Link to={"contacts"} smooth={true}><button className="fade-in cursor-pointer border rounded-full text-white text-sm lg:text-md px-4 bg-[#181818] py-2 border-gray-700 flex items-center hover:bg-[#F34F1C] hover:border-transparent transition-all duration-300 ease-in-out">
        ...
        <div className="fade-in pr-5 pl-5  md:pl-0  pt-0 md:pr-15 lg:pr-30 md:pt-5 flex flex-col md:order-2 order-1">
          <div className="fade-in cursor-pointer text-white text-md md:text-sm lg:text-[16px] font-medium flex justify-between px-8 sm:px-30 md:px-6 lg:px-10 xl:px-20 mb-4 ">
            <Link to="/" smooth={true}>
              Home
            </Link>
            <Link to="about" smooth={true} className="text-gray-500">
              About
            </Link>
            <Link to="projects" smooth={true} className="text-gray-500">
              Projects
            </Link>
            <Link to="contacts" smooth={true} className="text-gray-500">
              Contact
            </Link>
          </div>
